...
class OverlayView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private var results: List<ObjectDetectorHelper.DetectionResult> = LinkedList<ObjectDetectorHelper.DetectionResult>()
    ...
    override fun draw(canvas: Canvas) {
        ...
        for (result in results) {
            ...
            // Create text to display alongside the bounding box
            val drawableText =
